...
## 2026-05-18 (Cycle 1 — Baseline)

**Queries run:**
1. `Ebola outbreak May 2026 confirmed cases deaths` — broad baseline; surfaced WHO PHEIC declaration, DON602, Wikipedia article, Africa CDC, CNN, CBC, NPR
2. `Ebola 2026 WHO response country affected` — WHO DON602 and PHEIC page; ECDC monitoring notice; Al Jazeera and NPR coverage
3. `Ebola Goma DRC 2026 case confirmed spread` — confirmed Goma case (wife of Bunia victim traveled while infected); Uganda detail; Africa CDC updated URL
4. `Ebola Kinshasa case 2026 DRC capital spread healthcare worker` — confirmed Kinshasa case is ruled out (negative tests); HCW death details; STAT News PHEIC article
5. `Ebola 2026 travel advisory US State Department CDC Level` — CDC Level 2 for DRC, Level 1 for Uganda; US Embassy alerts (Kampala, Kinshasa, Juba); South Sudan alert May 17

**URLs fetched this cycle (6 successful, 1 timeout):**
...
- https://en.wikipedia.org/wiki/2026_Ituri_Province_Ebola_outbreak
- https://www.cidrap.umn.edu/ebola/new-ebola-outbreak-hits-democratic-republic-congo
- https://www.statnews.com/2026/05/17/who-ebola-drc-uganda-bundibugyo-pheic-public-health-emergency/
- https://www.npr.org/2026/05/16/g-s1-122494/a-new-ebola-outbreak-has-already-killed-87-people (TIMEOUT — try next cycle)

**URLs seen in results but NOT fetched (add to next cycle if relevant):**
...
- https://www.imperial.ac.uk/news/articles/2026/ebola-outbreak-2026-qa-with-experts/ (expert Q&A — good for next cycle)
- https://www.ecdc.europa.eu/en/news-events/who-declares-ebola-outbreak-democratic-republic-congo-public-health-emergency (ECDC monitoring)
- https://time.com/article/2026/05/17/who-global-emergency-ebola-Bundibugyo/
- https://wwwnc.cdc.gov/travel/notices/level2/ebola-democratic-republic-of-the-congo (CDC travel notice DRC)
- https://wwwnc.cdc.gov/travel/notices/level1/ebola-uganda (CDC travel notice Uganda)
- https://www.cdc.gov/ebola/situation-summary/index.html (CDC situation summary)
- https://ug.usembassy.gov/health-alert-u-s-embassy-kampala-may-15-2026/
- https://cd.usembassy.gov/health-alert-u-s-embassy-kinshasa-may-15-2026/
- https://ss.usembassy.gov/health-alert-u-s-embassy-juba-may-17-2026/
...
- https://www.directrelief.org/2026/05/drc-ebola-outbreak-ituri-bundibugyo-strain-2026/

**What NOT to search next cycle (already covered):**
- General "Ebola 2026 outbreak" — saturated
- Basic case counts — get from WHO DON directly
- "Kinshasa case" — resolved (negative)

**Priority searches for next cycle:**
- Goma response under M23 control (security/access reporting)
- Bundibugyo vaccine/treatment clinical trial announcements
- South Sudan border screening / case status
- Rwanda / CAR response measures
- WHO Emergency Committee governance (PHEIC-without-EC precedent)
