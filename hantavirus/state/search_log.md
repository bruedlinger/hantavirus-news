...
## Cycle 47 — 2026-05-27 (01:10–TBD UTC)

### Queries run
1. `hantavirus France Bichat patient ECMO death recovery May 2026` — French patient watch (HIGH)
2. `ECDC hantavirus Andes virus update May 23 24 25 26 27 2026` — ECDC updates (HIGH)
3. `hantavirus cruise ship MV Hondius update May 24 25 26 2026` — overall (HIGH)
4. `UKHSA hantavirus update Tristan da Cunha Arrowe Park May 23 24 25 26 2026` — UK (HIGH)
5. `WHO DON601 hantavirus cruise ship 2026 published update` — new WHO DON (HIGH)
6. `hantavirus Spain confirmed case Madrid hospital May 25 2026` — Spain 2nd case (HIGH)
7. `hantavirus Canada Yukon patient Victoria hospital update May 23 24 25 26 2026` — Canada (MEDIUM)
8. `Oceanwide Expeditions lawsuit passenger hantavirus legal May 2026` — legal angle (MEDIUM)
9. `CDC HAN 00529 hantavirus testing 2026` — new CDC HAN (MEDIUM)
10. `hantavirus France patient Bichat ECMO death recovery discharge May 26 27 2026` — French follow-up (HIGH)

### Pages fetched
- hantavirus.one ✓ — May 27 00:30 UTC: 11 confirmed + 2 probable = 13 total (per tracker), 3 deaths; French patient alive on ECMO, no update on outcome
- ecdc.europa.eu ✓ — May 26 15:00 update: 13 total (11 confirmed + 2 probable), 3 deaths; "one new case" since previous; case definition revised to PCR and/or serology (now aligned with WHO)
- edition.cnn.com/2026/05/25 ✗ (HTTP 451) — Spain 2nd case; known from search snippet/Euronews
- timescolonist.com Canada ✗ (HTTP 403) — known from search snippet: 3 in hospital Victoria
- cdc.gov/hantavirus/situation-summary ✓ — May 19 last update: 0 US confirmed cases; 18 Nebraska quarantine
- euronews.com Spain 2nd case ✓ — Spain 2nd case confirmed May 25 via routine PCR; patient in isolation at Gomez Ulla; "does not entail increased risk"
- gov.uk UKHSA ✓ — May 26 update: British confirmed case medically evacuated NL→England; 16 Arrowe Park contacts departed; Tristan still "suspected"
- rivm.nl ✓ — May 22 16:45 update: one Dutch home-quarantine passenger tested positive and hospitalized; risk of spread remains low

### What these queries found
**KEY NEW (Cycle 47)**: (1) **Dutch home-quarantine case (RIVM May 22)**: one Dutch passenger in home quarantine tested positive, hospitalized — count 11→12; first post-Rotterdam positive from home quarantine; (2) **Spain 2nd case (May 25)**: routine PCR at Gomez Ulla Hospital caught a second Spanish positive — count 12→13; both Spanish patients in isolation; (3) **ECDC May 26**: 13 total (11 confirmed + 2 probable), 3 deaths; case definition revised — serology alone now sufficient for "confirmed" status per WHO alignment; (4) **British case evacuated Netherlands→England (UKHSA May 26)**: British expedition guide (confirmed hantavirus) medically transported from Netherlands hospital to England; 16 of ~22 Arrowe Park contacts departed; (5) **WHO DON601 published** (~May 13 data): third WHO disease outbreak notice; 11 cases, Spain 1st + France added; (6) **French patient**: still alive on ECMO ~475+ hours (20 days) as of May 27 00:30 UTC; no death or recovery; (7) **Lancet article published** (PIIS0140-6736(26)00934-7); (8) **CDC HAN00529** (May 18): testing availability notice; 0 US confirmed; (9) **No lawsuits filed** against Oceanwide; (10) **Canada**: 3 in hospital Victoria — 1 confirmed (Yukon woman, stable), 2 asymptomatic monitored; WHO DON602 still not published.

### What to search next cycle (do NOT repeat for 24h)
- `hantavirus France Bichat patient recovery death discharge June 2026` — HIGH; daily French watch
- `ECDC hantavirus update May 27 28 June 2026` — HIGH
- `UKHSA hantavirus update Tristan da Cunha lab confirmed May 2026` — HIGH; lab result for Tristan
- `hantavirus Canada B.C. Victoria third case confirmed May 2026` — MEDIUM; clarify B.C. person status
